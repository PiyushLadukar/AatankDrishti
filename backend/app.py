...
if __name__ == '__main__':
    ...
    print('\nEndpoints:')
    print('  https://aatankdrishti.onrender.com/api/health')
    print('  https://aatankdrishti.onrender.com/api/summary')
    print('  https://aatankdrishti.onrender.com/api/ideology')
    print('  https://aatankdrishti.onrender.com/api/timeline')
    print('  https://aatankdrishti.onrender.com/api/region')
    print('  https://aatankdrishti.onrender.com/api/top-groups')
    print('  https://aatankdrishti.onrender.com/api/religion-subtype')
    print('  https://aatankdrishti.onrender.com/api/attack-types')
    print()
